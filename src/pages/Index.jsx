  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
      ...
      <Button 
        ...
        className="text-xl py-6 px-8 rounded-full bg-yellow-400 hover:bg-yellow-500 text-yellow-900 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-yellow-300"
      >
        Make it Rain! 🎉
      </Button>
